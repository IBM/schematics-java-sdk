...
/**
 * Unit test class for the WorkspaceActivityOptionsTemplate model.
 */
public class WorkspaceActivityOptionsTemplateTest {
  ...
  public void testWorkspaceActivityOptionsTemplate() throws Throwable {
    ...
    WorkspaceActivityOptionsTemplate workspaceActivityOptionsTemplateModelNew = TestUtilities.deserialize(json, WorkspaceActivityOptionsTemplate.class);
    assertTrue(workspaceActivityOptionsTemplateModelNew instanceof WorkspaceActivityOptionsTemplate);
  }
}