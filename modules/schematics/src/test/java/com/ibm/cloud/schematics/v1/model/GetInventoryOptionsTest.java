...
/**
 * Unit test class for the GetInventoryOptions model.
 */
public class GetInventoryOptionsTest {
  ...
  public void testGetInventoryOptionsError() throws Throwable {
    new GetInventoryOptions.Builder().build();
  }
