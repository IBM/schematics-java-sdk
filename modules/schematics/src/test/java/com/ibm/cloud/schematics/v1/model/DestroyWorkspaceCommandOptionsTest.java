...
/**
 * Unit test class for the DestroyWorkspaceCommandOptions model.
 */
public class DestroyWorkspaceCommandOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDestroyWorkspaceCommandOptions() throws Throwable {
  ...
  public void testDestroyWorkspaceCommandOptionsError() throws Throwable {
    new DestroyWorkspaceCommandOptions.Builder().build();
  }
