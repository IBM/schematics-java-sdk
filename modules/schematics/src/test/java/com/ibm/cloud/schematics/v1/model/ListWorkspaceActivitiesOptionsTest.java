...
/**
 * Unit test class for the ListWorkspaceActivitiesOptions model.
 */
public class ListWorkspaceActivitiesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListWorkspaceActivitiesOptions() throws Throwable {
  ...
  public void testListWorkspaceActivitiesOptionsError() throws Throwable {
    new ListWorkspaceActivitiesOptions.Builder().build();
  }
