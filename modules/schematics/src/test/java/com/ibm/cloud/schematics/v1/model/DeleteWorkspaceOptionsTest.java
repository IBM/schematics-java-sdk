...
/**
 * Unit test class for the DeleteWorkspaceOptions model.
 */
public class DeleteWorkspaceOptionsTest {
  ...
  public void testDeleteWorkspaceOptionsError() throws Throwable {
    new DeleteWorkspaceOptions.Builder().build();
  }
