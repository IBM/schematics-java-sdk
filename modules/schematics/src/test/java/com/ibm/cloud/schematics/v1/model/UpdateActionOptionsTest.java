...
public class UpdateActionOptionsTest {
  ...
  public void testUpdateActionOptions() throws Throwable {
    ...
    assertEquals(updateActionOptionsModel.bastionConnectionType(), "ssh");
    assertEquals(updateActionOptionsModel.inventoryConnectionType(), "ssh");
    assertEquals(updateActionOptionsModel.tags(), java.util.Arrays.asList("testString"));
    ...
    assertEquals(updateActionOptionsModel.credentials(), java.util.Arrays.asList(credentialVariableDataModel));
    assertEquals(updateActionOptionsModel.bastion(), bastionResourceDefinitionModel);
    assertEquals(updateActionOptionsModel.bastionCredential(), credentialVariableDataModel);
    assertEquals(updateActionOptionsModel.targetsIni(), "testString");
    assertEquals(updateActionOptionsModel.inputs(), java.util.Arrays.asList(variableDataModel));
    assertEquals(updateActionOptionsModel.outputs(), java.util.Arrays.asList(variableDataModel));
    assertEquals(updateActionOptionsModel.settings(), java.util.Arrays.asList(variableDataModel));
