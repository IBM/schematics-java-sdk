...
/**
 * Unit test class for the WorkspaceResponseList model.
 */
public class WorkspaceResponseListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testWorkspaceResponseList() throws Throwable {
    WorkspaceResponseList workspaceResponseListModel = new WorkspaceResponseList();
    assertNull(workspaceResponseListModel.getCount());
    assertNull(workspaceResponseListModel.getLimit());
    assertNull(workspaceResponseListModel.getOffset());
    assertNull(workspaceResponseListModel.getWorkspaces());
  }
}