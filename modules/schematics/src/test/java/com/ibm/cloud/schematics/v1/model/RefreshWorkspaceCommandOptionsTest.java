...
/**
 * Unit test class for the RefreshWorkspaceCommandOptions model.
 */
public class RefreshWorkspaceCommandOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRefreshWorkspaceCommandOptions() throws Throwable {
  ...
  public void testRefreshWorkspaceCommandOptionsError() throws Throwable {
    new RefreshWorkspaceCommandOptions.Builder().build();
  }
