...
public class JobDataWorkspaceTest {
  ...
  public void testJobDataWorkspace() throws Throwable {
    ...
    assertEquals(jobDataWorkspaceModelNew.workspaceName(), "testString");
    assertEquals(jobDataWorkspaceModelNew.flowId(), "testString");
    assertEquals(jobDataWorkspaceModelNew.flowName(), "testString");
    assertEquals(jobDataWorkspaceModelNew.updatedAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
  }
}