...
/**
 * Unit test class for the ReplaceInventoryOptions model.
 */
public class ReplaceInventoryOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceInventoryOptions() throws Throwable {
    ...
    assertEquals(replaceInventoryOptionsModel.description(), "testString");
  ...
  public void testReplaceInventoryOptionsError() throws Throwable {
    new ReplaceInventoryOptions.Builder().build();
  }
