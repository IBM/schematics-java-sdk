...
/**
 * Unit test class for the ListKmsOptions model.
 */
public class ListKmsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListKmsOptions() throws Throwable {
  ...
  public void testListKmsOptionsError() throws Throwable {
    new ListKmsOptions.Builder().build();
  }
