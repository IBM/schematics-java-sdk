...
/**
 * Unit test class for the UpdateJobOptions model.
 */
public class UpdateJobOptionsTest {
  ...
  @Test
  public void testUpdateJobOptions() throws Throwable {
    ...
    UpdateJobOptions updateJobOptionsModel = new UpdateJobOptions.Builder()
      ...
      .build();
    assertEquals(updateJobOptionsModel.jobId(), "testString");
    assertEquals(updateJobOptionsModel.refreshToken(), "testString");
    assertEquals(updateJobOptionsModel.commandObject(), "workspace");
    assertEquals(updateJobOptionsModel.commandObjectId(), "testString");
    assertEquals(updateJobOptionsModel.commandName(), "workspace_plan");
    assertEquals(updateJobOptionsModel.commandParameter(), "testString");
    assertEquals(updateJobOptionsModel.commandOptions(), java.util.Arrays.asList("testString"));
    assertEquals(updateJobOptionsModel.inputs(), java.util.Arrays.asList(variableDataModel));
    assertEquals(updateJobOptionsModel.settings(), java.util.Arrays.asList(variableDataModel));
    assertEquals(updateJobOptionsModel.tags(), java.util.Arrays.asList("testString"));
    assertEquals(updateJobOptionsModel.location(), "us-south");
    assertEquals(updateJobOptionsModel.status(), jobStatusModel);
    assertEquals(updateJobOptionsModel.cartOrderData(), java.util.Arrays.asList(cartOrderDataModel));
    assertEquals(updateJobOptionsModel.data(), jobDataModel);
    assertEquals(updateJobOptionsModel.bastion(), bastionResourceDefinitionModel);
    assertEquals(updateJobOptionsModel.logSummary(), jobLogSummaryModel);
    assertEquals(updateJobOptionsModel.agent(), agentInfoModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateJobOptionsError() throws Throwable {
    new UpdateJobOptions.Builder().build();
  }
