...
public class DeleteWorkspaceActivityOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteWorkspaceActivityOptions instance.
     *
     * @param deleteWorkspaceActivityOptions the instance to initialize the Builder with
     */
  ...
  protected DeleteWorkspaceActivityOptions() { }
