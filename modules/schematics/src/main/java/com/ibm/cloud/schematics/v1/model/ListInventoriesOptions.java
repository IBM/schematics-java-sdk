...
public class ListInventoriesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListInventoriesOptions instance.
     *
     * @param listInventoriesOptions the instance to initialize the Builder with
     */
  ...
  protected ListInventoriesOptions() { }
