...
public class UpdateJobOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(UpdateJobOptions updateJobOptions) {
      ...
      this.commandObject = updateJobOptions.commandObject;
      this.commandObjectId = updateJobOptions.commandObjectId;
      this.commandName = updateJobOptions.commandName;
      this.commandParameter = updateJobOptions.commandParameter;
      this.commandOptions = updateJobOptions.commandOptions;
      this.inputs = updateJobOptions.inputs;
      this.settings = updateJobOptions.settings;
