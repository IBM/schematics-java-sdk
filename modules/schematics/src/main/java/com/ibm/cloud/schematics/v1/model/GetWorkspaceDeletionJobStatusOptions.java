...
public class GetWorkspaceDeletionJobStatusOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetWorkspaceDeletionJobStatusOptions instance.
     *
     * @param getWorkspaceDeletionJobStatusOptions the instance to initialize the Builder with
     */
  ...
  protected GetWorkspaceDeletionJobStatusOptions() { }
