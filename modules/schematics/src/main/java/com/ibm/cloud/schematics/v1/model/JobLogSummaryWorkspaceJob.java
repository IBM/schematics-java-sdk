 ...
 */
public class JobLogSummaryWorkspaceJob extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing JobLogSummaryWorkspaceJob instance.
     *
     * @param jobLogSummaryWorkspaceJob the instance to initialize the Builder with
     */
  ...
  protected JobLogSummaryWorkspaceJob() { }
