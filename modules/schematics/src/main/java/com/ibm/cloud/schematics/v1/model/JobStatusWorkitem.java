...
public class JobStatusWorkitem extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing JobStatusWorkitem instance.
     *
     * @param jobStatusWorkitem the instance to initialize the Builder with
     */
