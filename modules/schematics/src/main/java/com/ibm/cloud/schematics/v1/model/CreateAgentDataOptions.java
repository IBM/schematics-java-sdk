...
/**
 * The createAgentData options.
 */
public class CreateAgentDataOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing CreateAgentDataOptions instance.
     *
     * @param createAgentDataOptions the instance to initialize the Builder with
     */
    private Builder(CreateAgentDataOptions createAgentDataOptions) {
      this.name = createAgentDataOptions.name;
      this.resourceGroup = createAgentDataOptions.resourceGroup;
      this.version = createAgentDataOptions.version;
      this.schematicsLocation = createAgentDataOptions.schematicsLocation;
      this.agentLocation = createAgentDataOptions.agentLocation;
      this.agentInfrastructure = createAgentDataOptions.agentInfrastructure;
      this.description = createAgentDataOptions.description;
      this.tags = createAgentDataOptions.tags;
      this.agentMetadata = createAgentDataOptions.agentMetadata;
      this.agentInputs = createAgentDataOptions.agentInputs;
      this.userState = createAgentDataOptions.userState;
      this.agentKpi = createAgentDataOptions.agentKpi;
    }
    ...
    /**
     * Builds a CreateAgentDataOptions.
     *
     * @return the new CreateAgentDataOptions instance
     */
    public CreateAgentDataOptions build() {
      return new CreateAgentDataOptions(this);
    }
     ...
     * @return the CreateAgentDataOptions builder
     */
  ...
  protected CreateAgentDataOptions() { }

  protected CreateAgentDataOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a CreateAgentDataOptions builder
   */
