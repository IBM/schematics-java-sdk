...
public class ExecuteResourceQueryOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ExecuteResourceQueryOptions instance.
     *
     * @param executeResourceQueryOptions the instance to initialize the Builder with
     */
  ...
  protected ExecuteResourceQueryOptions() { }
