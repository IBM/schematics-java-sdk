...
public class DeleteInventoryOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteInventoryOptions instance.
     *
     * @param deleteInventoryOptions the instance to initialize the Builder with
     */
  ...
  protected DeleteInventoryOptions() { }
