...
public class DeleteResourcesQueryOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteResourcesQueryOptions instance.
     *
     * @param deleteResourcesQueryOptions the instance to initialize the Builder with
     */
  ...
  protected DeleteResourcesQueryOptions() { }
