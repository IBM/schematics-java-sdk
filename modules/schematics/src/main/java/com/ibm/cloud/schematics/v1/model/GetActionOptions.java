...
public class GetActionOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetActionOptions instance.
     *
     * @param getActionOptions the instance to initialize the Builder with
     */
