...
public class TemplateRepoUpdateRequest extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing TemplateRepoUpdateRequest instance.
     *
     * @param templateRepoUpdateRequest the instance to initialize the Builder with
     */
    private Builder(TemplateRepoUpdateRequest templateRepoUpdateRequest) {
      ...
      this.skipSubmodulesCheckout = templateRepoUpdateRequest.skipSubmodulesCheckout;
    }
  ...
  protected TemplateRepoUpdateRequest() { }
