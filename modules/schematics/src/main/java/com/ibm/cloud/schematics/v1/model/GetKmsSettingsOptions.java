...
public class GetKmsSettingsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetKmsSettingsOptions instance.
     *
     * @param getKmsSettingsOptions the instance to initialize the Builder with
     */
  ...
  protected GetKmsSettingsOptions() { }
