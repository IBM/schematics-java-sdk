...
public class ListActionsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListActionsOptions instance.
     *
     * @param listActionsOptions the instance to initialize the Builder with
     */
